...
const CRYPTO_SYMBOLS = [
  "BTC", "ETH", "USDT", "BNB", "SOL", "XRP", "USDC", "ADA", "DOGE", "AVAX", "SHIB","TAO", "DOT", "LINK", "TRX","CRO","TON","WLFI", "MATIC", "WBTC", "NEAR","UNI", "LTC", "DAI", "BCH", "PEPE","SUI", "ICP", "APT", "ETC", "RENDER", "STX", "FIL", "ARB","IMX", "VET", "MKR", "GRT", "LDO", "INJ", "RUNE","ASTER","SKY", "THETA","MORPHO","WLD", "FTM", "FET", "JUP", "BEAM", "CORE", "PYTH", "FLOKI", "BONK", "ONDO", "SEI", "GALA", "WIF", "PENDLE", "AR", "TIA", "HBAR", "ATOM", "W", "AAVE", "ALGO", "QNT", "FLOW", "SNX", "EGLD", "SAND", "MANA", "AXS", "EOS", "NEO", "IOTA", "XLM", "XMR", "ZEC", "DASH", "BTG", "CHZ", "HOT", "ENJ", "ZIL", "BAT", "ANKR", "RVN", "KAVA", "LRC", "KNC", "CRV", "1INCH", "SUSHI", "YFI", "COMP", "BAL", "UMA", "DYDX", "WOO", "GMX", "RPL", "SSV", "LPT", "ENS", "GLMR", "MOVR", "MINA", "ROSE", "CELO", "METIS", "TWT", "STRK", "ZETA","MANTA", "ALT", "SATS", "ORDI", "BOME", "MEME", "BLUR", "XAI", "MAGIC", "GNS", "JOE", "WELL", "FLUX", "AKT", "NOS", "PRIME", "TRAC", "PAXG", "BTT", "VTHO", "BICO", "IOTX", "SCRT", "CKB", "CEL", "ONE", "WIN", "SKL", "GAL", "GMT", "APE", "ARKM", "ID", "MAV", "EDU", "HOOK", "POLYX", "RIF", "STG", "RDNT", "HFT", "LQTY", "GTC", "OCEAN", "AGIX", "POL", "KDA", "JASMY", "RNDR", "ENA","ZRO","DEXE","PUMP","JST","CAKE","VIRTUAL","PENGU","DASH","XTZ","SEI","DCR","KITE","GNO","CFX","KAIA","SYRUP","HNT","LIT","LUNC","AXS"
];
